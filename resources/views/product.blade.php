  ...
  <input type="hidden" id="userId" name="id" value="{{ $product->id }}">
    ...
    <div class="mt-10">
        ...
        <div class="mt-6 inline-flex">
            <button type="submit"
                class="mt-6 text-red-600 bg-gray-200 dark:bg-white border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-xl font-bold hover:bg-red-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                Reservar já
            </button>
        </div>
        </form> --}}
              ...
              <form method="get" action="/order">
                ...
                <div class="grid grid-flow-row lg:grid-flow-col">
                  <img class="h-96 mx-auto" src="../{{ $product->photo }}" alt="">
                    {{-- Product Information --}}
                    <div class="text-gray-900 dark:text-white mt-6 px-8 md:px-14 space-y-4 md:w-3/4">
