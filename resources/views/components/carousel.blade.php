<div class="flex flex-col xl:flex-row bg-black">
    ...
    <div class="text-white p-6 space-y-4 text-base sm:text-lg text-justify 2xl:w-2/4">
        <h2 class="font-semibold text-3xl">Sobre o NECM</h2>
        ...
        <p>Por forma a garantir uma excelente comunicação e entreajuda com todos, teremos sempre ao dispor o nosso e-mail e, também, todas as redes sociais, das quais dispomos informação.</p>
    </div>
</div>