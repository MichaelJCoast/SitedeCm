<template>
    <div class="container min-h-screen mx-auto lg:mt-6 px-8 md:px-14 text-neutral-900 dark:text-white">
      ...
      <p v-else>Desculpa, este link já se encontra expirado.</p>
  </div>
</template>
...
export default {
  ...
  data(){
      ...
      const expirationHour = queryStringLastPart.split("?")[1].split("=")[1].split("%20")[1];
      ...
      let checkExpirationDate = today >= expirationDate && time >= expirationHour;
      return {
        checkExpirationDate
      }
  }
